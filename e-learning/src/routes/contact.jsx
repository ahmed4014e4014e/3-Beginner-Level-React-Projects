...
export default function Contact() {
  return (
    <>
    <header class="contaienr header pt-4">
      ...
      <div class="container">
        ...
        <br />
        <p>
          Thank you for choosing <a style={{color: "blue", textDecoration: "underline"}} href='https://volerelife.wordpress.com/'>MenyhartMedia</a>. We look forward to serving you.
        </p>
        <br />
      </div>
    </header>
